          ...
          child: Column(
            children: [
               ListTile(
                leading: IconButton(
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const Graphs(),));
              ...
              ListTile(
                leading: IconButton(
                    onPressed: () async {
                      ...
                      await prefs.clear();
                           SharedPreferences tectcontrol=await SharedPreferences.getInstance();
                           await tectcontrol.clear();
                           final transationDb = await Hive.openBox<TransationModel>('transationDb');
                           final categorydb = await Hive.openBox<CategoryModel>('category_name');
